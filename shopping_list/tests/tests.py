...
def test_shopping_list_includes_only_corresponding_items():
    ...
    ShoppingItem.objects.create(name='Eggs', shopping_list=shopping_list, purchased=False)
    ShoppingItem.objects.create(name='The Seven Sisters', shopping_list=another_shopping_list, purchased=False)
...
@pytest.mark.django_db
def test_shopping_item_is_retrieved_by(create_shopping_item):
